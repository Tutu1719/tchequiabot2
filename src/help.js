...
║115 *${prefix}clonar [@]*
║116 *${prefix}ping [ver velocidade do bot]*
║117 *${prefix}termux*
║118 *${prefix}gay [@]*
║119 *${prefix}wame*
║120 *${prefix}map (nome)*
║121 *${prefix}setppbot (marque uma img)*
║122 *${prefix}pinterest (nome)*
║123 *${prefix}desligar (so para o dono)*
║124 *${prefix}timer*
║
╠══✪〘 MAIS ALGUNS 〙✪══
║
║125 *${prefix}neko*
║126 *${prefix}ttp [texto]*
║127 *${prefix}testime*
║128 *${prefix}tomp3*
║129 *${prefix}animehug*
║130 *${prefix}shoturl*
...
║
║ *NOME: tutu1719*
║ *TWITTER:https://twitter.com/tutu1719?s=09 *
║ *WPP: wa.me/+5562994686815*
║ *YOUTUBE:https://youtube.com/channel/UCHxo15XZdoZMaV5Hb2e8mpA*
║
║  *"Peita ou respeita 🐊🚩*
